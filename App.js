...
class App extends React.Component {
  ...
  componentDidMount = () => {
    ...
    this.socket = io.connect(
      ...
      'https://a775f2b64033.ngrok.io/webrtcPeer',
      {
        path: '/io/webrtc',
        query: {}
      }
    ...
    //연결실패시 소켓통신 버전 확인 : socket.io-client": "^2.3.1" 버전 주의
    ...
    console.log(" componentDidMount -=-=-=-=-=-=-=종료")
  }
            ...
            <View style={{ flex: 1, }}>
              <TouchableOpacity onPress={this.createOffer}>
                <View style={styles.button}>
                  <Text style={{ ...styles.textContent, }}>Call 호출</Text>
                </View>
              </TouchableOpacity>
            </View>
            <View style={{ flex: 1, }}>
